...
<div class="panel-body">
	    ...
	    <tr><td></td><td><input type="hidden" name="pengunjung_id" value="<?php echo $pengunjung_id; ?>" /> 
	    <button type="submit" class="btn btn-danger"><i class="fas fa-save"></i> <?php echo $button ?></button> 
	    <a href="<?php echo site_url('pengunjung') ?>" class="btn btn-info"><i class="fas fa-undo"></i> Kembali</a></td></tr>
</thead>
	</table></form>        </div>
</div>
</div>
